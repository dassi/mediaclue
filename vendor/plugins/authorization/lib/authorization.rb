  ...
  module Base
    ...
    module ControllerInstanceMethods
      ...
      def handle_redirection
        ...
        if @current_user
          flash[:notice] = "Sie haben keine Berechtigung für dieses Objekt. Bitte melden Sie sich als berechtiger Benutzer an."
        else
          flash[:notice] = @options[:redirect_message] ? @options[:redirect_message] : "Anmeldung erforderlich."
        end
