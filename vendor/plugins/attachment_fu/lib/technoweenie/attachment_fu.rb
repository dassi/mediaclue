  ...
  module AttachmentFu # :nodoc:
    ...
    module ClassMethods
      ...
      def self.extended(base)
        ...
        # Andreas Brodbeck (mindclue): Konflikt mit authorizable-Mixin, welches attr_protected verwendet
    ...
    module InstanceMethods
      ...
      def thumbnail_name_for(thumbnail = nil)
        ...
        if attachment_options[:processor] == "ImageScience"
          ext.sub!(/gif$/, 'png') 

          # Andreas Brodbeck (mindclue):
          # TIFFs werden nach JPG gewandelt
          ext.sub!(/tiff$/, 'jpg') 
          ext.sub!(/tif$/, 'jpg')  
        end
