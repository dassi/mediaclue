...
class ActiveRecord::Base #:nodoc:
  ...
  module TaggingFinders
    ...
    def parse_tags(tags)
      ...
      tags = tags.respond_to?(:flatten) ? tags.flatten : tags.split(Tag::PARSE_EXPRESSION).reject {|s| s.empty? }
      tags.map { |tag| tag.strip.squeeze(" ") }.flatten.compact.map { |e| ActiveSupport::Multibyte::Handlers::UTF8Handler.downcase(e) }.uniq
    end
